...
export const userUpdateProfileReducer = (state = {}, action) => {
	switch (action.type) {
		...
		case USER_UPDATE_PROFILE_RESET:
			return { loading: false, success: false, userInfo: null, error: null };
		default:
			return state;
	}
};
...
export const userListReducer = (state = { loading: false, error: false, success: false, users: null }, action) => {
	switch (action.type) {
		...
		case USER_LIST_SUCCESS:
			return { loading: false, success: true, users2: action.payload };
		case USER_LIST_FAIL:
			return { loading: false, error: action.payload };
		case USER_LIST_RESET:
			return { loading: false, error: false, success: false, users: null };
		default:
			return state;
	}
};
